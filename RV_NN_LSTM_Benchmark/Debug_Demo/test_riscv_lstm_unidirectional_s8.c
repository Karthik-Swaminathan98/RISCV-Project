...
#include "../TestData_ARM/lstm_1/test_data.h"
#include "../TestData_ARM/lstm_2/test_data.h"
#include "../TestData_ARM/lstm_one_time_step/test_data.h"
#include "validate.h"
#include <math.h>
#include <stdlib.h>
#include <string.h>
...
//    const int32_t output_ref_size = LSTM_1_BATCH_SIZE * LSTM_1_TIME_STEPS * LSTM_1_HIDDEN_SIZE;
    ...
    // INPUT GATE
    const nmsis_nn_lstm_gate gate_input = {LSTM_1_INPUT_GATE_INPUT_MULTIPLIER,
    ...
    // FORGET GATE
    const nmsis_nn_lstm_gate gate_forget = {LSTM_1_FORGET_GATE_INPUT_MULTIPLIER,
    ...
    // CELL GATE
    const nmsis_nn_lstm_gate gate_cell = {LSTM_1_CELL_GATE_INPUT_MULTIPLIER,
    ...
    // OUTPUT GATE
    const nmsis_nn_lstm_gate gate_output = {LSTM_1_OUTPUT_GATE_INPUT_MULTIPLIER,
...
//	uint32_t start_cycles_s8 = read_cycle_counter();
    ...
    riscv_lstm_unidirectional_s8(lstm_1_input_tensor, output, &params, &buffers);
    printf("2");
...
void lstm_2(void)
{
    ...
    const nmsis_nn_lstm_gate gate_input = {LSTM_2_INPUT_GATE_INPUT_MULTIPLIER,
    ...
    const nmsis_nn_lstm_gate gate_forget = {LSTM_2_FORGET_GATE_INPUT_MULTIPLIER,
    ...
    const nmsis_nn_lstm_gate gate_cell = {LSTM_2_CELL_GATE_INPUT_MULTIPLIER,
    ...
    const nmsis_nn_lstm_gate gate_output = {LSTM_2_OUTPUT_GATE_INPUT_MULTIPLIER,
    ...
    const nmsis_nn_lstm_params params = {LSTM_2_TIME_MAJOR,
                                         LSTM_2_BATCH_SIZE,
                                         LSTM_2_TIME_STEPS,
                                         LSTM_2_INPUT_SIZE,
                                         LSTM_2_HIDDEN_SIZE,
    ...
    riscv_lstm_unidirectional_s8(lstm_2_input_tensor, output, &params, &buffers);
...
void lstm_one_time_step(void)
{
   ...
   // const riscv_nmsis_nn_status expected = riscv_nmsis_NN_SUCCESS;
    ...
    // INPUT GATE
    const nmsis_nn_lstm_gate gate_input = {LSTM_ONE_TIME_STEP_INPUT_GATE_INPUT_MULTIPLIER,
    ...
    // FORGET GATE
    const nmsis_nn_lstm_gate gate_forget = {LSTM_ONE_TIME_STEP_FORGET_GATE_INPUT_MULTIPLIER,
    ...
    // CELL GATE
    const nmsis_nn_lstm_gate gate_cell = {LSTM_ONE_TIME_STEP_CELL_GATE_INPUT_MULTIPLIER,
    ...
    // OUTPUT GATE
    const nmsis_nn_lstm_gate gate_output = {LSTM_ONE_TIME_STEP_OUTPUT_GATE_INPUT_MULTIPLIER,
    ...
    // LSTM DATA
    const nmsis_nn_lstm_params params = {LSTM_ONE_TIME_STEP_TIME_MAJOR,
    ...
    riscv_lstm_unidirectional_s8(lstm_one_time_step_input_tensor, output, &params, &buffers);
