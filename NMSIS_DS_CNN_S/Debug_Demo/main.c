...
int ds_cnn_s_s8_get_buffer_size(void)
{
    ...
    int32_t size = riscv_convolve_wrapper_s8_get_buffer_size(&conv_params, &input_dims, &filter_dims, &output_dims);
    ...
    size = riscv_depthwise_conv_wrapper_s8_get_buffer_size(&dw_conv_params, &input_dims, &filter_dims, &output_dims);
...
int main(void) {
    ...
    printf("Start execution NMSIS DS-CNN to classify image\r\n");
    delay_ms(20);
    /* start the execution */
	...
	nmsis_nn_dims in_out_dim_0;
	nmsis_nn_dims conv_filter_dims;
	nmsis_nn_dims dw_conv_filter_dims;
	nmsis_nn_dims in_out_dim_1;
	...
	riscv_nmsis_nn_status status = riscv_convolve_wrapper_s8(&ctx,
														 &conv_params,
														 &quant_params,
														 &in_out_dim_0,
														 ds_cnn_s_input,
	...
	status |= riscv_depthwise_conv_wrapper_s8(&ctx,
											&dw_conv_params,
											&quant_params,
											&in_out_dim_1,
											in_out_buf_0,
	...
	status |= riscv_convolve_wrapper_s8(&ctx,
									  &conv_params,
									  &quant_params,
									  &in_out_dim_0,
									  in_out_buf_1,
	...
	status |=
		riscv_avgpool_s8(&ctx, &pool_params, &in_out_dim_1, in_out_buf_0, &conv_filter_dims, &in_out_dim_0, in_out_buf_1);
	...
	nmsis_nn_per_tensor_quant_params per_tensor_quant_params;
	...
	status |= riscv_fully_connected_s8(&ctx,
									 &fc_params,
