...
#define stack_limit 0x0009F000
#define stack_top 0x000A0000
...
void layer0_riscv_depthwise_conv_s8(uint32_t *total_cycles, uint32_t *total_stack) {
    // Define tensor and layer parameters for Layer 0
    const int input_h = 49, input_w = 10, input_c = 1;
    const int kernel_h = 10, kernel_w = 4, ch_mult = 172;
    const int output_h = 25, output_w = 10, output_c = 172;
    ...
    nmsis_nn_dims input_dims, filter_dims, bias_dims = {0}, output_dims;
    ...
    const int32_t buf_size = riscv_depthwise_conv_wrapper_s8_get_buffer_size(&dw_conv_params,
                                                                           &input_dims,
                                                                           &filter_dims,
                                                                           &output_dims);
    ...
    // Print results
    printf("layer0_riscv_depthwise_conv_s8\n\r");
...
void layer2_riscv_depthwise_conv_s8(uint32_t *total_cycles, uint32_t *total_stack) {
    ...
    const int input_h = 27, input_w = 12, input_c = 172;
    const int kernel_h = 3, kernel_w = 3, ch_mult = 172;
    const int output_h = 13, output_w = 5, output_c = 172;

    const size_t input_size = input_h * input_w * input_c;
    const size_t weight_size = kernel_h * kernel_w * ch_mult;
    const size_t bias_size = output_c;
    const size_t output_size = output_h * output_w * output_c;
    ...
    // Print results
    printf("layer2_riscv_depthwise_conv_s8\n\r");
    printf("Stack Used: %lu bytes\n\r", (unsigned long)stack_used);
    printf("Cycle Count: %lu\n\r", (unsigned long)cycle_count);
...
void layer3_riscv_conv_s8(uint32_t *total_cycles, uint32_t *total_stack) {
    ...
    const int input_h = 13, input_w = 5, input_c = 172;
    const int kernel_h = 1, kernel_w = 1, ch_mult = 172;
    const int output_h = 13, output_w = 5, output_c = 172;
    ...
    // Calculate scratch buffer size
    const int32_t buf_size = riscv_convolve_wrapper_s8_get_buffer_size(&conv_params,
                                                                     &input_dims,
                                                                     &filter_dims,
                                                                     &output_dims);
    ctx.buf = malloc(buf_size);
...
void layer4_riscv_depthwise_conv_s8(uint32_t *total_cycles, uint32_t *total_stack) {
    // Define tensor and layer parameters for Layer 4
    const int input_h = 13, input_w = 5, input_c = 172;
    const int kernel_h = 3, kernel_w = 3, ch_mult = 172;
    const int output_h = 13, output_w = 5, output_c = 172;
    ...
    // Print results
    printf("layer4_riscv_depthwise_conv_s8\n\r");
    printf("Stack Used: %lu bytes\n\r", (unsigned long)stack_used);
    printf("Cycle Count: %lu\n\r", (unsigned long)cycle_count);

    // Layers 4, 6, 8, 10
	cycle_count = cycle_count * 4;
	stack_used = stack_used * 4;

    printf("*****Layers 4, 6, 8, 10: DEPTHWISE_CONV_2D cycle count: %lu\n\r", (unsigned long)cycle_count);
    printf("*****Layers 4, 6, 8, 10: DEPTHWISE_CONV_2D stack usage: %lu\n\r", (unsigned long)stack_used);
...
void layer12_riscv_avgpool_s8(uint32_t *total_cycles, uint32_t *total_stack) {
    ...
    const int input_h = 13, input_w = 5, input_c = 172;
    const int output_h = 1, output_w = 1, output_c = 172;
    const int filter_h = 13, filter_w = 5;
    ...
    nmsis_nn_dims input_dims, output_dims,filter_dims;
    ...
    const int32_t buf_size = riscv_avgpool_s8_get_buffer_size(output_w, input_c);
    ctx.buf = malloc(buf_size);
    ctx.size = buf_size;
    ...
    uint32_t start_cycles = read_cycle_counter();
    riscv_avgpool_s8(&ctx, &pool_params, &input_dims, input, &filter_dims, &output_dims, output);
    uint32_t end_cycles = read_cycle_counter();
    uint32_t stack_used = measure_stack_usage();
    uint32_t cycle_count = end_cycles - start_cycles;
    ...
    // Print results
    printf("layer12_riscv_avgpool_s8\n\r");
    printf("Stack Used: %lu bytes\n\r", (unsigned long)stack_used);
    printf("Cycle Count: %lu\n\r", (unsigned long)cycle_count);
...
void layer13_riscv_fully_connected_s8(uint32_t *total_cycles, uint32_t *total_stack) {
    ...
    const int input_n = 1, input_h = 1, input_w = 1, input_c = 1;
    const int output_n = 1, output_c = 12;
    const int filter_n = 172, filter_c = 12;
    ...
    // Print results
    printf("Layer 13: Fully Connected (riscv_fully_connected_s8)\n\r");
    printf("Stack Used: %lu bytes\n\r", (unsigned long)stack_used);
    printf("Cycle Count: %lu\n\r", (unsigned long)cycle_count);
    printf("Output:\n\r");
