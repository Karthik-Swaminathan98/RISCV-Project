...
Debug_Demo/%.o: ../Debug_Demo/%.c Debug_Demo/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-Debug_Demo

clean-Debug_Demo:
	-$(RM) ./Debug_Demo/app.d ./Debug_Demo/app.o ./Debug_Demo/main.d ./Debug_Demo/main.o

.PHONY: clean-Debug_Demo
