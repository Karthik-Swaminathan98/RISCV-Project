...
common/bt_debug/%.o: ../common/bt_debug/%.c common/bt_debug/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-common-2f-bt_debug

clean-common-2f-bt_debug:
	-$(RM) ./common/bt_debug/dbgport.d ./common/bt_debug/dbgport.o

.PHONY: clean-common-2f-bt_debug
