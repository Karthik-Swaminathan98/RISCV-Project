...
vendor/common/auto_test/%.o: ../vendor/common/auto_test/%.c vendor/common/auto_test/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-vendor-2f-common-2f-auto_test

clean-vendor-2f-common-2f-auto_test:
	-$(RM) ./vendor/common/auto_test/pc_interface.d ./vendor/common/auto_test/pc_interface.o

.PHONY: clean-vendor-2f-common-2f-auto_test
